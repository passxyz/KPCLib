...
{
    public static class PxEncryption
    {
        ...
        public static string EncryptWithPassword(string secretMessage, string password)
        {
            ...
            {
                password = string.Format("{0,-15}", password);
            }

            return SimpleEncryptWithPassword(secretMessage, password);
        }
        ...
        public static string DecryptWithPassword(string encryptedMessage, string password)
        {
            ...
            return SimpleDecryptWithPassword(encryptedMessage, password);
        }
